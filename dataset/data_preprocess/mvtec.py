...
class MVTecSolver(object):
    ...
    def __init__(self, root="/home/ubuntu/public_d/zjh/datasets/mvtec_anomaly_detection", train_ratio=0.5):
        self.root = root
        self.meta_path = f'{root}/meta.json'
        self.train_ratio = train_ratio
...
if __name__ == '__main__':
    runner = MVTecSolver(root="/home/ubuntu/public_d/zjh/datasets/mvtec_anomaly_detection")
    runner.run()
